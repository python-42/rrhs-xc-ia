...
public class RaceSQLTest {
    ...
    public void testSQLWrite() {
        ...
        assertEquals(Level.VARSITY_BOYS, race1.getLevel());
        ...
        assertEquals(LocalDate.of(2023, 10, 14), race2.getMeetDate());
        assertEquals(Level.JV_BOYS, race2.getLevel());
    ...
    public void testSQLRead() {
        ...
        assertEquals("'0'", resultRow1.get(SQLTableInformation.Race.LEVEL_ENUM));
        ...
        assertEquals("'2023-10-14'", resultRow2.get(SQLTableInformation.Race.MEET_DATE_STR));
        assertEquals("'2'", resultRow2.get(SQLTableInformation.Race.LEVEL_ENUM));
